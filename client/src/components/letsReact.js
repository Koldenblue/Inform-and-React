...
function letsReact(){
 return (
    <div className="theBody">
        <div>
            <div id="mapDiv">
                <img className="mapSection" id="daMap" alt="electoral map 2020" src="../letsReact_img/download.jpeg" />
        ...
        <div className="votingInfo">
            <div id="thisIsLegit">
                <div className="votersIn">
                    <img className="voteImages" alt="voting feet" src="../letsReact_img/vote.jpg" />
                    <h2>Election Day</h2>
                ...
                <div className="votersIn">
                    <img className="voteImages" alt="vote here sign" src="../letsReact_img/page-header.jpeg" />
                ...
                <div className="votersIn">
                    <img className="voteImages" alt="ballot in hand" src="../letsReact_img/5f217d6d4e52b7232d63289c.jpeg" />
            ...
            <div id="stillTooLegitToQuit">
                <div className="votersIn">
                    <img className="voteImages" alt="you vote counts" src="../letsReact_img/1-65764-your-vote-counts.jpg" />
                ...
                <div className="votersIn">
                    <img className="voteImages" alt="vote by mail" src="../letsReact_img/voting-by-mail-could-lead-to-prosecution.jpg" />
                ...
                <div className="votersIn">
                    <img className="voteImages" alt="cast your ballot with safety" src="../letsReact_img/200428162238-wisconsin-primary-vote-coronavirus-full-169.jpg" />
